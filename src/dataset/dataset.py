...
from src.dataset.dataset_base import StandardData
from .classes import get_split_classes
from .utils import make_dataset


def get_val_loader(args: argparse.Namespace, episodic=True) -> torch.utils.data.DataLoader:
    """
    ...
    if episodic:
        ...
        val_data = StandardData(args, val_transform, class_list=base_class_list, return_paths=False,
...
class MultiClassValData(Dataset):
    ...
    def generate_support(self, query_image_path_list, remove_them_from_query_data_list=False):
        '''
        output:
        spprt_imgs: [num_novel_classes*shot,c,h,w]
        spprt_labels:[num_novel_classes*shot,h,w]
        '''
